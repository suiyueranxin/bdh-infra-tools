...
source ${BASE_FOLDER}/infrabox_debug_gke_custom_commit_id.sh
...
if [ -d /tmp/hanalite-releasepack_continues_validation_debug_gke ]; then
  rm -rf /tmp/hanalite-releasepack_continues_validation_debug_gke/*
else
  mkdir -p /tmp/hanalite-releasepack_continues_validation_debug_gke
fi

pushd /tmp/hanalite-releasepack_continues_validation_debug_gke
cp ${BASE_FOLDER}/infrabox_debug_gke.json infrabox.json
