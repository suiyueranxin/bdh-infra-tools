sap.ui.controller("bdhreport.case_detail_nightly", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf bdhreport.case_detail_nightly
*/
		...
		this.getView().addEventDelegate( 
			{
				onBeforeShow : function(evt) {
					var oModel =  this.getView().byId("caseListNightly").getModel();			    	
	...
	goBackDBList:function(){
		this.getSplitContObj().toDetail("nightly_validation_report");
	},
	...
	onCollapseAll: function() {
		var oTreeTable = this.getView().byId('caseListNightly');
